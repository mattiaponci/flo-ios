...
let SITES_SAVE_REF = DB_REF.child("sites-save")
let USER_SAVED_SITES_REF = DB_REF.child("user_posts_sites")

let USER_FEED_REF = DB_REF.child("user-feed")

let USER_LIKES_REF = DB_REF.child("user-likes")
let POST_LIKES_REF = DB_REF.child("post-likes")
let USER_SAVED_REF = DB_REF.child("user-save")
...
let USER_SAVED_POSTS_REF = DB_REF.child("user-save")
