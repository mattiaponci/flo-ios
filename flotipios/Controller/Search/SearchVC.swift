   ...
   override func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        if searchText.isEmpty || searchText == " " {
            inSearchMode = false
            filteredUsers.removeAll() // Svuota i risultati filtrati
            tableView.isHidden = true // Nascondi la tabella
            ...
            tableView.isHidden = false // Mostra la tabella
            tableView.reloadData()
        }
    }
    ...
    func searchBarCancelButtonClicked(_ searchBar: UISearchBar) {
        searchBar.endEditing(true) // Chiude la tastiera
        searchBar.showsCancelButton = false // Nasconde il pulsante Cancel
        searchBar.text = nil // Svuota il testo della barra di ricerca

        // Disabilita la modalità di ricerca
        inSearchMode = false
        filteredUsers.removeAll() // Svuota i risultati filtrati
        ...
        // Rendi visibile la collectionView, se necessario
